...
public class Browse extends HttpServlet
{
	...
	HttpSession session = request.getSession(false);
	    ...
	    out.print("<h1 style='font-style: cursive;'> <strong> Browsing !!!  <strong> </h1>");
            ...
            try
            {
                ...
                String qu1 = "select isbn, booktitle, author, category, quantity, price from newbook";
...
"  }");
                ...
                out.print("<table>");
                out.print("<caption> <center> Book Shelf </center> </caption>");
                out.print("<thead>");
                out.print("<tr>");
                ...
                out.print("<br> <br>");
                out.print("<form action='AddCart' method='get'>");
                out.print("<input type='text' name='aisb' placeholder='Enter ISBN Number' />");
                out.print("<button type='submit' class=\"anchor\"> <i class=\"fa fa-shopping-cart fa-lg fa-fw\" aria-hidden=\"true\"> </i> </button>");
                out.print("</form>");
