...
"  }");
                ...
                out.print("<table>");
                out.print("<caption> <center> Shopping Book Cart </center> </caption>");
                out.print("<thead>");
                out.print("<tr>");
                ...
                out.print("<br> <br>");
                out.print("<form action='RemoveItem' method='get'>");
                out.print("<input type='text' name='aisb' placeholder='Enter ISBN Number' />");
                out.print("<button type='submit' class=\"anchor\"> <i class=\"fa fa-trash fa-lg fa-fw\" aria-hidden=\"true\"> </i> </button>");
                out.print("</form>");
                
                out.print("<br> <br>");
                out.print("<a href=\"OrderItems\" class=\"anchor\"> Place Order </a>");
