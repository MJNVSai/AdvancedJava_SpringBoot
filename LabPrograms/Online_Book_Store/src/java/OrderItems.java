...
public class OrderItems extends HttpServlet
{
	...
	HttpSession session = request.getSession(false);
	    ...
	    out.print("<h1 style='font-style: cursive; font-family: sans-serif;'> <strong> Final Orders <strong> </h1>");
            ...
            try
            {
                ...
                String qu1 = "select isbn, booktitle, quantity, price from newbook where trash = 'no'";
...
"  }");
                ...
                out.print("<table>");
                out.print("<caption> <center> Finalize Your Order </center> </caption>");
                out.print("<thead>");
                out.print("<tr>");
                ...
                while(rs.next())
                {
                    ...
                    totalcost = totalcost + rs.getFloat(4);
                    out.print("</tr>");
                    out.print("</tbody>");
                }
                out.print("</table>");
                ...
                out.print("<h2 style='font-style: cursive; font-family: sans-serif; color: darkblue;'>  Total Cost : " +totalcost+ " &#x20B9; </h2>");
                out.print("<a href=\"#\" class=\"anchor\" style='float:right;' onclick='ShowAlert();'> Buy </a>");
                out.print("<a href=\"DeleteOrder\" class=\"anchor\" style='float:left;'> Cancel </a>");
                out.print("</div>");
                
                out.print("</center>");
                
                out.print("<script>");
                out.print("function ShowAlert(){alert('Your Order has Been Confirmed Soon you Will Get an Email Notication');}");
                out.print("</script>");
